...
const secretKey = 'asjgfjagudfjbdvjaksugd'; 
...
function authenticate(req, res, next) {
  ...
  // Define a protected route that uses the authenticate middleware
// router.get('/profile', authenticate, (req, res) => {
//     const email = req.email;
//     res.json({ message: `Hello, ${email}! This is your profile.` });
//   });
...
router.post('/signin', (req, res) => {
    ...
    //taking the email and hashing it using secret key
